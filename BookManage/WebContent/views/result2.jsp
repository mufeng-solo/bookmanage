...
<body>
			...
			<div class="container-fluid">
	            ...
	            <div class="collapse navbar-collapse">
					...
					%>			
								...
								<li class="login1"><form action="${pageContext.request.contextPath }/sign_out_contro/userSignOut1" method="post"><button type="submit" class="btn btn-danger btn-xs">退出</button></form></li>
					<%
							}else if(info.equals("null")){ 
								session.removeAttribute("info");
								session.removeAttribute("user");
								%>
									<li><a href="#" class="btn3">登录</a></li>
						            <li><a href="#" class="btn4">注册</a></li>
								<%	
							}
						}else{
					%>
    ...
    <button type="button" class="close" ><span>&times;</span></button>
        ...
        <form action="" method="post">
	            用户名:<input name="uname" id="uname" type="text" placeholder="请输入用户名"/><br>
	            密码:<input name="upwd" id="upwd" type="password" placeholder="请输入密码"/>
